...
class SchoolChatReactions extends React.Component<any> {
	render() {
		return (
			<LessonPage>
				<LessonHeadContain>
				...
				<LessonBody>
					<LessonOverview>
						...
						<br />
						An example of this is using the Reaction only on your Stream Deck
						<br />
						<br />
...
export default withRouter(connect<any, any, any>(null, null)(SchoolChatReactions));