...
class SchoolScenes extends React.Component<any> {
	render() {
		return (
			<LessonPage>
				<LessonHeadContain>
					<LessonHead>
						...
						<Button onClick={() => this.props.history.push('/school/Reactions')}>Next Lesson ></Button>
					</LessonHead>
					<LessonHeaderRow />
				</LessonHeadContain>
				<LessonBody>
...
export default withRouter(connect<any, any, any>(null, null)(SchoolScenes));
