...
class SchoolHypes extends React.Component<any> {
	render() {
		return (
			<LessonPage>
				<LessonHeadContain>
					<LessonHead>
						...
						<Button onClick={() => this.props.history.push('/school/fuze')}>Next Lesson ></Button>
					</LessonHead>
					<LessonHeaderRow />
				</LessonHeadContain>
				<LessonBody>
					<LessonOverview>
						...
						<h2>Type</h2>
						<br />
						First option is <b>Type</b> which cannot be changed at this time
						<br />
						<br />
						<h2>Value Type</h2>
						<br />
...
export default withRouter(connect<any, any, any>(null, null)(SchoolHypes));