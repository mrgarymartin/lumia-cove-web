...
const nextUp = require('../../school-order.json').chatGeneral;

class SchoolStudioFuze extends React.Component<any> {
	render() {
		return (
			<LessonPage>
				<LessonHeadContain>
				...
				<LessonBody>
					<LessonOverview>
						...
						<br />
						<br />
						<div>Next section on the list is <Link to={nextUp.path}><NiceButton>{nextUp.name}</NiceButton></Link></div>
					</LessonOverview>
				</LessonBody>
			</LessonPage>
		);
...
export default withRouter(connect<any, any, any>(mapState, mapDispatch)(SchoolStudioFuze));