			...
			<LessonPage>
				...
				<LessonBody>
					<LessonOverview>
						...
						<br />
						This will allow you to continuously animate your lights until a alert or command comes in
						<br />
						Even after an alert or command does come in it will start the animation back up
						<LessonSubtitle>Let’s create a Animation</LessonSubtitle>
						The studio is where we create all of our base types to be used within Lumia
						<br />
						It is very similar to the Animation builder
						<br />
						Navigate to Studio -> Animations
						<br />
						Let's click Add Animation in the top right corner
						<br />
						...
						<br />
						You will also have the ability to set the brightness and select certain lights to be used within each slot if so desire.
						<br />
						...
						<br />
						<br />
						That wraps up Studio Animations, now that you've created a animation you'll be able to select them it in your <Link to='/school/lights/default'><b>Default Lights</b></Link>
						<br />
						<br />
